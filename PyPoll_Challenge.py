...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in counties:
        ...
        county_results = (f"{county_name}: {countyvote_percentage:.1f}% ({county_votecount:,})\n")
        ...
        if (county_votecount > county_largest_votecount):
            # if true, then overwrite variables
            county_largest_votecount = county_votecount
